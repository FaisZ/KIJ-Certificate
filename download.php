			...
			<div id="page-wrapper">
				<div id="page-inner">
                    ...
                    <?php
					   ...
					   {
					   	echo "<div class='alert alert-dismissable alert-success' style='width:900px; margin-left:200px;'>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        	...
                        	echo $file;
                        	?>
                        		<a href="<?php echo "User/" . $_SESSION["file"] . ".crt"; ?>"><button class="btn btn-success" type="submit" name="update">Download</button></a>
                    		</div>
